...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/vpnmultiplus-89/MULTIPLUS_V3/main/"
...
TIMES=30
    ...
    local USRSC=$(wget -qO- https://raw.githubusercontent.com/vpnmultiplus-89/MULTIPLUS_V3/main/register | grep "$ipsaya" | awk '{print $2}' | head -n 1)
    local EXPSC=$(wget -qO- https://raw.githubusercontent.com/vpnmultiplus-89/MULTIPLUS_V3/main/register | grep "$ipsaya" | awk '{print $3}' | head -n 1)
    if [[ -z "$passwd" ]]; then
...
"
    local REPLY_MARKUP='{"inline_keyboard":[[{"text":"🌐 Website","url":"https://allxdev.com/sewa"},{"text":"🛠 Kontak","url":"https://wa.me/6287873951705"}]]}'
...
wget https://raw.githubusercontent.com/vpnmultiplus-89/MULTIPLUS_V3/main/menu.zip
unzip menu.zip
chmod +x menu/*
